...
|| defined(__AVR_ATmega169__)   || defined(__AVR_ATmega169P__)  || defined(__AVR_ATmega169P__)  \
...
|| defined (__AVR_ATmega16__) || defined (__AVR_ATmega32__)
  ...
  /* ===================== EXUP ENTEGRASYONU ===================== */
  // SPI flash'ta EXUPv1 imajı varsa: doğrula + Intel HEX uygula → yeni FW
  if (exup_check_and_update()) {
    // Güncelleme başarılı → hızlı WDT reset ile uygulamaya geç
    watchdogConfig(WATCHDOG_16MS);
    while (1) { } // 16ms sonra reset; uygulama başlar
  }
  /* =================== /EXUP ENTEGRASYONU ====================== */
